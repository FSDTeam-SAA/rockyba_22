...
exports.bookingAdminEmail = void 0;
const bookingAdminEmail = (booking) => `
  <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
    ...
    <ul>
      ...
      <li><strong>How Did They Find Us:</strong> ${booking.personalInfo.howDidYouFindUs || "N/A"}</li>
    </ul>
...
`;
exports.bookingAdminEmail = bookingAdminEmail;
